...
/* A CHARACTER seasoning is the paste or sauce that MAKES the dish — sambal, belacan,
   oyster sauce, miso, gochujang. It is "assumed" (you don't weigh it) but it is not
   background. Salt, oil and garlic ARE background: they're in everything and would swamp
   the signal. The affinity graph must see the character seasonings, or it can never learn
   that sambal goes with kangkong — which is the whole point of a stir-fry. */
const CHARACTER_SEASONINGS=new Set([
  "sambal","belacan","shrimp_paste","laksa_paste","tom_yum_paste","curry_powder",
  "oyster_sauce","dark_soy_sauce","hoisin","fermented_beancurd","gochujang","gochugaru",
  "miso","dashi","kimchi","tamarind","dried_shrimp","salted_fish","salted_vegetable",
  "star_anise","dang_gui","white_pepper","coconut_milk","fish_sauce","kaffir_lime",
  "lemongrass","galangal","turmeric","curry_leaves","shaoxing","mirin","wolfberry"
]);
...
const STIRFRY_DIRS=[
  ...
  {key:"dried_chilli", label:"Dried chilli", region:"Sichuan",
   markers:["chilli","doubanjiang"], need:1,
